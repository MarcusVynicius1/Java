...
public class Pessoa {
	...
	public String retornarPessoa() {
		return "Nome: " + this.nome + " Descrição: " + this.descricao + " Genero: " + this.genero + " País: " + this.pais + " Ocupação: "
				+ this.ocupacao + " Ano de Nascimento: " + this.anoDeNacimento + " Ano de Falecimento: " + this.anoDeFalecimento;
	} 
}
