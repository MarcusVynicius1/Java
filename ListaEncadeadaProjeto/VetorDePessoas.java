...
public class VetorDePessoas implements ColecaoDePessoas {
	...
	public void ordenarLista(Ordenador ordenador) {
		//Decidir qual metodo de ordenacao irá ser usado (listaDePessoas, inicio, fim)
	...
	public String buscaSequencial(String nomeBuscado) {
	        int contador = 0;
	        String mostrarNome = null;
	        for(contador = 0; contador < this.totalDePessoas; contador++) {
	            if(nomeBuscado.equals(this.listaDePessoas[contador].obterNome())) {
	                return mostrarNome = this.listaDePessoas[contador].retornarPessoa();
	            }
	        }
